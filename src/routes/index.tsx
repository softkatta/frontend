    ...
    children: [
      {
        ...
        children: [
          ...
          { path: 'portfolio', lazy: lazyPage(() => import('@/pages/public/PortfolioPage')) },
          ...
          { path: 'refund-policy', lazy: lazyPage(() => import('@/pages/public/RefundPolicyPage')) },
          { path: 'shipping-policy', lazy: lazyPage(() => import('@/pages/public/ShippingPolicyPage')) },
